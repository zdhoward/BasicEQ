...
void ResponseCurveComponent::paint(juce::Graphics& g)
{
    ...
    auto responseArea = getAnalysisArea(); //getRenderArea();//getLocalBounds();//bounds.removeFromTop(bounds.getHeight() * 0.33);
    ...
    analyzerEnabledButtonAttachment(audioProcessor.apvts, "Analyzer Enabled", analyzerEnabledButton)
{
    ...
    auto safePtr = juce::Component::SafePointer<BasicEQAudioProcessorEditor>(this);
